...
__all__ = [
    'RepResNet', 'Represnet10', 'Represnet18', 'Represnet34', 'Represnet50', 'Represnet101',
    'Represnet152', 'Represnet200'
]
...
def Represnet10(**kwargs):
    ...
    """
    model = RepResNet(BasicBlock, [1, 1, 1, 1], **kwargs)
    return model


def Represnet18(**kwargs):
    """Constructs a ResNet-18 model.
    """
    model = RepResNet(BasicBlock, [2, 2, 2, 2], **kwargs)
    return model


def Represnet34(**kwargs):
    """Constructs a ResNet-34 model.
    """
    model = RepResNet(BasicBlock, [3, 4, 6, 3], **kwargs)
    return model
...
def Represnet50(**kwargs):
    ...
    """
    model = RepResNet(Bottleneck, [3, 4, 6, 3], **kwargs)
    return model


def Represnet01(**kwargs):
    """Constructs a ResNet-101 model.
    """
    model = RepResNet(Bottleneck, [3, 4, 23, 3], **kwargs)
    return model


def Represnet152(**kwargs):
    """Constructs a ResNet-101 model.
    """
    model = RepResNet(Bottleneck, [3, 8, 36, 3], **kwargs)
    return model


def Represnet200(**kwargs):
    """Constructs a ResNet-101 model.
    """
    model = RepResNet(Bottleneck, [3, 24, 36, 3], **kwargs)
    return model